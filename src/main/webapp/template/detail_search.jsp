            ...
            <c:when test="${result != null && result.documents != null && fn:length(result.documents) > 0}">
                ...
                <div class="operations-box">
                    <div class="operation-link">
                        <a href="#"
                           onclick="document.getElementById('tag-page').style.display='none';document.getElementById('tag-all').style.display='block';return false;">Tag
                            All Results</a>
                    </div>
                    <div class="operation-link">
                        <a href="#"
                           onclick="document.getElementById('tag-all').style.display='none';document.getElementById('tag-page').style.display='block';return false;">Tag
                            This page</a>
                    </div>
                    <div class="operation-link">
                ...
                <c:forEach var="doc" items="${result.documents}">
                    <div class="result-box">
                        <div class="operations-box">
                            <div class="operation-link">
                                <a href="#"
                                   onclick="document.getElementById('tag-doc-${doc.documentId}').style.display='block';return false;">Tag</a>
                            </div>
                            <div class="operation-link">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:length(entry.value) > 300}">
                                                        ...
                                                        <div id="textid-coll-${doc.documentId}"
                                                            ...
                                                            The text has been truncated. Click <a href="#"
