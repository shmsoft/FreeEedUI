<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <script src="js/freeedai.js?v=2"></script>
        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="edis-pred-container">
                    <button class="edis-pred-button" onclick="sendQuestion(event)" id="responsive_question">Responsive
                        documents</button>
                    <button class="edis-pred-button" onclick="sendQuestion(event)" id="privileged_question">Privileged
                        documents</button>
                    <button class="edis-pred-button" onclick="sendQuestion(event)" id="smoking_gun_question">Smoking gun
                        documents</button>
