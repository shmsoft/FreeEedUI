            ...
            <div class="chat-page">
                    ...
                    <form name="change" method="post" action="freeeedai.html" class="chat-case-form">
                        ...
                        <select class="chat-case-select your-case-select" id="case_Select" name="id">
                            <c:forEach var="c" items="${cases}">
                                <option value="${c.id}" data-project-id="${c.projectId}" ${(selectedCase !=null &&
                                    selectedCase.id==c.id) ? 'selected' : '' }>${c.name}</option>
                            </c:forEach>
                        </select>
                ...
                <div class="chat-messages" id="chat-messages-area">
                    <div class="chat-welcome" id="chat-welcome">
                        ...
                        <p class="chat-welcome-sub">Ask questions about your legal documents, or pick a suggestion
                            below.</p>
                    </div>
                ...
                <div class="chat-input-area">
                    <div class="chat-chips" id="chat-chips">
                        <button class="chat-chip" onclick="sendTemplateQuestion(event,'responsive')">📄 Responsive
                            docs</button>
                        <button class="chat-chip" onclick="sendTemplateQuestion(event,'privileged')">🔒 Privileged
                            docs</button>
                        <button class="chat-chip" onclick="sendTemplateQuestion(event,'smoking_gun')">🔫 Smoking gun
                            docs</button>
                        <button class="chat-chip" onclick="sendTemplateQuestion(event,'timeline')">📅 Timeline of
                            events</button>
                        <button class="chat-chip" onclick="sendTemplateQuestion(event,'key_parties')">👥 Key
                            parties</button>
                    </div>
                    <form name="casifyAIForm" onsubmit="onSubmit(event)" class="chat-input-row">
                        ...
                        <input type="text" class="question_input chat-input"
