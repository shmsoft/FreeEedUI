...
*/
package org.freeeed.search.web.model.cases;
...
public class Case implements Serializable {
    ...
    private String esSourceIndices;
    ...
    public String getEsSourceIndices() {
        return esSourceIndices;
    }

    public void setEsSourceIndices(String esSourceIndices) {
        this.esSourceIndices = esSourceIndices;
    }
    ...
    public synchronized void addAllTags(Set<String> tags) {
        tags.addAll(tags);
    }
